...
public class RequestHandler implements Runnable {
    ...
    private void openDBConnection() {
        ...
        Base.open("com.mysql.jdbc.Driver", "jdbc:mysql://" + Application.CONFIG.getProperty("server") + ":" + Application.CONFIG.getProperty("mysql_port") + "/" + "steamrankings_test_db"
                + "?characterEncoding=utf8", Application.CONFIG.getProperty("mysql_username"), Application.CONFIG.getProperty("mysql_password"));
    ...
    // returns JSONArray of sorted hashmaps; hashmap<steamprofile,
    ...
    private void processGetGameLeaderboard(int appid) throws Exception {
        ...
        for (ProfilesGames profilegame : profilesgames) {
            ...
            sp = new SteamProfile(profile.getInteger("profile_id") + SteamProfile.BASE_ID_64, profile.getString("community_id"), profilegame.getString("persona_name"), profile.getString("real_name"),
                    ...
                    profile.getString("avatar_medium_url"), profile.getString("avatar_icon_url"), new DateTime(profile.getString("last_logoff")));
        ...
        sendResponseUTF(socket, "HTTP/1.1 200" + CRLF, "Content-type : " + "application/json ; charset=UTF-8" + CRLF, js.toString());
    }
